(function () {
  'use strict';
  angular.module('app.api').service('EmployeeCategoriesService', EmployeeCategoriesService);

  /** @ngInject */
  function EmployeeCategoriesService(Restangular) {
    this.show = show;
    this.index = index;
    this.create = create;
    this.update = update;
    ...
    var RESOURCE = 'employee_categories';
